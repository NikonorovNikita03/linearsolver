...
class TransportationSolver(QMainWindow):
    ...
    def create_controls(self):
        ...
        self.solve_btn.setStyleSheet(constants.solve_btn)
    ...
    def show_input_page(self):
        """Показать страницу с исходными данными"""
        self.stacked_widget.setCurrentIndex(0)
        self.solve_btn.setVisible(True)
        self.back_btn.setVisible(False)
    
    def show_solution_page(self):
        """Показать страницу с решением"""
    ...
    def create_solution_page(self):
        ...
        # Виджет для отображения общей стоимости
        ...
        # Создаем кнопки для управления решением
