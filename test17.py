...
class TransportationSolver(QMainWindow):
    ...
    def create_input_tables(self):
        ...
        top_area.addWidget(costs_group, stretch=5)  # Основная ширина
        top_area.addWidget(supply_group, stretch=0)  # Фиксированная ширина
        ...
        demand_layout.setContentsMargins(5, 5, 5, 5)
        ...
        input_layout.addWidget(demand_group, stretch=1)
